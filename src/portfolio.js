...
const greeting = {
  username: "Pinacle",
  title: "Pinacle'23",
  subTitle: emoji("28th and 29th November, 2022\n Do Something Sustainable"),
  resumeLink:
...
const desc = {
  ...
  schools: [
    {
      schoolName: "11+ Events",
      logo: require("./assets/images/event.png"),
      subHeader: "Experience..Expertise..Everytime",
      duration: "",
      desc: "Come and participate in the exceptional tech and non-tech events organized just for you.",
      descBullets: []
    },
    {
      schoolName: "₹21,000+ Worth Cash Prizes",
      logo: require("./assets/images/prize.png"),
      subHeader: "An award recognizing your talent is an honour",
      duration: "",
      desc: "Get a hold of exciting gifts for participation",
      descBullets: []
    }
  ]
};
  ...
  experience: [
    {
      ...
      company: "Facebook",
      companylogo: require("./assets/images/prize.png"),
